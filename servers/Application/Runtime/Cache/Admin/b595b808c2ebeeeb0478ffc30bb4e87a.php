...
<link rel="stylesheet" type="text/css" href="/Application/Admin/Public/css/theme.min.css" />
<link rel="stylesheet" type="text/css" href="/Application/Admin/Public/css/simplebootadmin.css" />
<link rel="stylesheet" type="text/css" href="/Application/Admin/Public/css/font-awesome.min.css" />

<!--[if IE 7]>
	<link rel="stylesheet" type="text/css" href="/Application/Admin/Public/css/font-awesome-ie7.min.css" />
<![endif]-->
<link rel="stylesheet" type="text/css" href="/Application/Admin/Public/css/simplebootadminindex.min.css" />
<!--[if lte IE 8]>
	<link rel="stylesheet" type="text/css" href="/Application/Admin/Public/css/simplebootadminindex-ie.css" />
<![endif]-->
...
<body style="min-width:900px;" screen_capture_injected="true">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<a href="<?php echo u('Index/index');?>" class="brand">
					<small><img src="/Application/Admin/Public/images/icon/logo-18.png">后台</small>
				</a>
				<div class="pull-left nav_shortcuts" >
					<a class="btn btn-small btn-success" href="/" title="网站首页面" target="_blank">
						<i class="fa fa-th"></i>
					</a>
					<!--
					...
					-->
					<script type="text/javascript" src="/Application/Admin/Public/js/jquery.js"></script>
					<link rel="stylesheet" type="text/css" href="/Application/Admin/Public/js/artDialog/skins/default.css" />
					<script type="text/javascript" src="/Application/Admin/Public/js/artDialog/artDialog.js"></script>
  ...
  function org_list() {
    ...
    $.get('/index.php/Admin/Org/org_list', {}, function(e) {
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="/Application/Admin/Public/images/icon/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>">
