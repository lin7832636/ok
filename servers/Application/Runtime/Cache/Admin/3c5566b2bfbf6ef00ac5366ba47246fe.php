...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/ok/servers/Application/Admin/Public/css/admin_login.css" />
		<style>
			#login_btn_wraper{
				text-align: center;
			}
...
<body>
	<div class="wrap">
		<h1><a><img src="/ok/servers/Application/Admin/Public/images/admin/login/logo.png" alt=""></a></h1>
