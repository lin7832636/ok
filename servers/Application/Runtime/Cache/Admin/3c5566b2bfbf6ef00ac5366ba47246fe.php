...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/bochong/servers/Application/Admin/Public/css/admin_login.css" />
		<style>
			#login_btn_wraper{
				text-align: center;
			}
...
<body>
	<div class="wrap">
		<h1><a><img src="/bochong/servers/Application/Admin/Public/images/admin/login/logo.png" alt=""></a></h1>
