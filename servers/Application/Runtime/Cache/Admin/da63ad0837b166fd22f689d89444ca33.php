    ...
    <div class="common-form">
       ...
       <th>操作</th>
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr align="center">
                            ...
                            <td>
                                <img src="/bochong/servers/<?php echo ($v["brand_logo"]); ?>" alt="" height="60px" width="60px">
                            </td>
                            ...
                            <td><a href="/bochong/servers/index.php/Admin/Brand/del?id=<?php echo ($v["brand_id"]); ?>" >删除</a>||<a href="/bochong/servers/index.php/Admin/Brand/upda?id=<?php echo ($v["brand_id"]); ?>">修改</a></td>
