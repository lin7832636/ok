...
<div class="b2b2c_layout">
    ...
    <!--头部start-->
    <header class="b2b2c_login_header">密码找回
    ...
    <section class="b2b2c_login_box">
        <form action="#">
            <div class="b2b2c_login_mobile b2b2c_login_mib">
                ...
                <input type="text" name="" id="b2b2c_telno" class="" value="" maxlength="" tabindex="1" aria-label=""placeholder="请输入手机号">
            </div>
            <div class="b2b2c_login_verify b2b2c_login_mib clearfix">
                ...
                <label for="b2b2c_user_sms_code"  class="fr tc">
                    <i title="验证码" id="b2b2c_button_user_sms" onclick="b2b2cf.user_sms($('#b2b2c_telno').val(), true);">获取验证码</i>
            ...
            <div class="b2b2c_login_confirm">
                <input type="button" id="button_register_submit" value="请点击校验" onclick="b2b2cf.forgetpassword();">
            </div>
