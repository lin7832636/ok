...
.error_left_img{
	width:40%;
	float: left;
	background:url(/oks/client/ThinkPHP/Tpl/images/error.jpg) no-repeat right;
...
.success_left_img{
	background: url(/oks/client/ThinkPHP/Tpl/images/success.jpg) no-repeat right;
	background-size:60% 60%; 
}
</style>
</head>
<script src="/oks/client/ThinkPHP/Tpl/js/jquery.js"></script>
<script src="/oks/client/ThinkPHP/Tpl/js/rem.js"></script>
