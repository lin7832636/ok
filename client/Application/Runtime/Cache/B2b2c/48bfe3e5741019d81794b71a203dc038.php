...
<html>
    <head>
        ...
        <script type="text/javascript">var GV = {DIMAUB: "/bochong/client/", MODULE_URL: "/bochong/client/index.php/B2b2c/"};</script>
    ...
    <!--表单区域start-->
        <section class="b2b2c_add_new_address">
            ...
            <div class="b2b2c_newadd_inner bgcf clearfix">
                ...
                <input type="image" name="is_default" src="/bochong/client/Application/B2b2c/Public/images/icons/030.png" class="fr" value="0" onclick="b2b2cf.add_address_is_default();">
                <!--点击以后input的image 换成 src="../images/icons/031.png"-->
            </div>
        </section>
    <!--表单区域end-->
</div>
<script type="text/javascript" src="/bochong/client/Application/B2b2c/Public/plug/area/areas.js"></script>
<!--地区选择插件-->
