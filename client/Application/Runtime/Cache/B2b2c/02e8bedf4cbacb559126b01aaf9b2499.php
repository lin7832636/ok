...
.error_left_img{
	width:40%;
	float: left;
	background:url(/client/ThinkPHP/Tpl/images/error.jpg) no-repeat right;
...
.success_left_img{
	background: url(/client/ThinkPHP/Tpl/images/success.jpg) no-repeat right;
	background-size:60% 60%; 
}
</style>
</head>
<script src="/client/ThinkPHP/Tpl/js/jquery.js"></script>
<script src="/client/ThinkPHP/Tpl/js/rem.js"></script>
